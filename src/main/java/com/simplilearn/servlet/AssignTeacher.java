...
public class AssignTeacher extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String hql_teacher= "from Teacher where Teach_FName='" + nameArray[0] + "'" + " and Teach_LName='" + nameArray[1] + "'";
		List<Teacher> teachers = session.createQuery(hql_teacher).list();
		
		String hql_subject = "update Subjects s set s.teacher=:n where s.subjectName=:sn";
