...
public class AssignSubject extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String hql_clas= "from SubClasses where c_name='" + clas + "'";
		List<SubClasses> classes = session.createQuery(hql_clas).list();
		
		String hql_subject = "update Subjects s set s.classes=:n where s.subjectName=:sn";
